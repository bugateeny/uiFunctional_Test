package pagesForWebElementMethods;
...
public class BasePage {
    ...
    WebDriverWait wait;  //  Created wait object
        ...
        public BasePage(WebDriver driver) {  //  define a constructor class to identify element to be used
    ...
    public void clearExistingText(WebElement element){
        waitForVisibilityOfElement(element);
